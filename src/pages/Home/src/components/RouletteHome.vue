...
<template>
  <div class="relative w-70 h-72">
    ...
    <div class="absolute top-12 left-8 w-19 h-19">
      <img src="./public/coin.webp" alt="coin" />
    </div>
    <div class="absolute ml-auto mr-auto left-0 right-0 w-30">
      <img
        src="./public/progress.webp"
        alt="progress"
    ...
    >
      <div class="flex items-center gap-3">
        ...
        <div class="w-full flex items-center justify-between">
          <div class="flex items-center gap-2">
            <img src="./public/money.webp" alt="money" class="w-7 h-7" />
            <span>30</span>
          </div>
      ...
      <div class="mt-3 flex gap-3">
        ...
        <div class="flex gap-1">
          <img src="./public/tokencoin.webp" alt="tokencoin" class="w-7 h-7" />
          <span>150</span>
        </div>
      </div>
      <div
    ...
    <div class="absolute left-2 top-23 w-16 h-13 rotate-12">
      ...
      <div class="absolute top-8 w-16 rotate-160">
        <img src="./public/button.png" alt="button" class="h-7" />
        <p
